...
export default function PeriodicTable() {
    ...
    const elements = [
        ...
        {num: 29, id:'Cu', name:'Copper', mass:'63.546', x:11, y:7, isotopes: []},
        {num: 30, id:'Zn', name:'Zinc', mass:'65.38', x:12, y:7, isotopes: []},
        {num: 31, id:'Ga', name:'Gallium', mass:'69.723',  x:13, y:7, isotopes: []},
        {num: 32, id:'Ge', name:'Germanium', mass:'72.63', x:14, y:7, isotopes: []},
        {num: 33, id:'As', name:'Arsenic', mass:'74.9216',  x:15, y:7, isotopes: []},
        {num: 34, id:'Se', name:'Selenium', mass:'78.96', x:16, y:7, isotopes: []},
        {num: 35, id:'Br', name:'Bromine', mass:'79.904',  x:17, y:7, isotopes: []},
        {num: 36, id:'Kr', name:'Krypton', mass:'83.798', x:18 , y:7, isotopes: []},
    
        {num: 37, id:'Rb', name:'Rubidium', mass:'85.4678', x:1, y:6, isotopes: []},
        {num: 38, id:'Sr', name:'Strontium', mass:'87.62', x:2, y:6, isotopes: []},
        {num: 39, id:'Y', name:'Yttrium', mass:'88.90585', x:3, y:6, isotopes: []},
        {num: 40, id:'Zr', name:'Zirconium', mass:'91.224', x:4, y:6, isotopes: []},
